...
<table class="table table-bordered">
    ...
    <tbody>
    <?php $nomor=1 ?>
        <?php $ambil=$db_koneksi->query("SELECT * FROM pembelian JOIN pelanggan ON pembelian.
        ...
        <tr>
            ...
            <td>
                ...
                class="btn-info btn">Detail Pembelian</a>

                <?php if ($pecah['status_pembelian'] == "SUDAH LUNAS"): ?>
